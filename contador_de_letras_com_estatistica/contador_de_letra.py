...
def analisa_frequencia_de_palavras(texto1):
  texto1 = texto1.lower().split()
  palavras = Counter(texto1)
  total_palavras = sum(palavras.values())
  print(total_palavras)
  print(palavras.most_common(10))
  for palavra,valor in palavras.most_common(10):
    print("{} => {:.2f}%".format(palavra, valor / total_palavras * 100))


  #proporcoes_palavras = [(palavras, frequencia / total_de_palavras) for letra, frequencia in palavras.items()]
  #proporcoes_palavras = Counter(dict(proporcoes_palavras))
  #mais_comuns = proporcoes_palavras.most_common(10)
  #for palavras, proporcao in mais_comuns:
  #  print("{} => {:.2f}%".format(palavras, proporcao * 100))
